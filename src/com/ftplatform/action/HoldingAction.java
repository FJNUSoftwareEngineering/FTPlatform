...
public class HoldingAction extends ActionSupport {
	...
	public void setFundHoldingService(FundHoldingServiceImpl fundHoldingServiceImpl) {
	...
	public String addholding() throws Exception {
		...
		temp_relust=fundHoldingService.fundHoldbyAccNo(financialAccount.getAccNo());
